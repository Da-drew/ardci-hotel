...
<?php include 'includes-pages/menu-navigation.php' ?>
        ...
        <div class="category-main-title">
            <h2 class="catg-title starter-title">Bilao</h2>
            <p class="catg-subtitle starter-sub-title">Small(6 pax), Medium(8 pax), Large(12 pax)</p>
        </div>
        <div class="row">
            <!-- Bihon Guisado card -->
                ...
                <div class="menu-categories-card-container flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Bihon Guisado</h1>
                        </div>
                        ...
                        <div class="add-list-con"><button class="add-list-btn" onclick="bihonGuisadoBilao()"><i class="fa-solid fa-clipboard-list"></i> Order</button></div>
                    </div>
                </div>
            </a>
            ...
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container mccc-right flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Pancit Canton</h1>
                        </div>
                        <div class="mcc-ing bilao-bspace">
                            <p class="">
                        ...
                        <div class="add-list-con"><button class="add-list-btn" onclick="pancitCantonGuisadoBilao()"><i class="fa-solid fa-clipboard-list"></i> Order</button></div>
                    </div>
                </div>
            </a>
                ...
                <div class="menu-categories-card-container flex-grow-1">
                    <div class="mcc-ing-preview">
                        ...
                        <div class="mcc-ing bilao-bspace">
                            ...
                            <div class="checkbox-price-con">
                                <div class="form-check form-bilao">
                                    <input class="form-check-input rice-checkbox" type="radio" name="carbonara" id="carbonaraSmall">
                                    <label class="form-check-label rice-checbox-label" for="carbonaraSmall">
                                        &#8369;390.00 (S)
                                    </label>
                                </div>
                                <div class="form-check form-bilao">
                                    <input class="form-check-input rice-checkbox" type="radio" name="carbonara" id="carbonaraMedium">
                        ...
                        <div class="add-list-con"><button class="add-list-btn" onclick="carbonaraBilao()"><i class="fa-solid fa-clipboard-list"></i> Order</button></div>
                    </div>
                </div>
            </a>
             ...
             <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container mccc-right flex-grow-1">
                    <div class="mcc-ing-preview">
                        ...
                        <div class="add-list-con"><button class="add-list-btn" onclick="spagBilao()"><i class="fa-solid fa-clipboard-list"></i> Order</button></div>
                    </div>
                </div>
            </a>
            ...
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container flex-grow-1">
                    <div class="mcc-ing-preview">
                        ...
                        <div class="add-list-con"><button class="add-list-btn" onclick="sotanghonBilao()"><i class="fa-solid fa-clipboard-list"></i> Order</button></div>
                    </div>
                </div>
            </a>
            ...
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container mccc-right flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Miki Bihon</h1>
                        </div>
                        <div class="mcc-ing bilao-bspace">
                            <p class="">
                        ...
                        <div class="add-list-con"><button class="add-list-btn" onclick="mikiBihonBilao()"><i class="fa-solid fa-clipboard-list"></i> Order</button></div>
                    </div>
                </div>
            </a>
            ...
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container flex-grow-1">
                    <div class="mcc-ing-preview">
                        ...
                        <div class="add-list-con"><button class="add-list-btn" onclick="bihonBilao()"><i class="fa-solid fa-clipboard-list"></i> Order</button></div>
                    </div>
                </div>
            </a>
