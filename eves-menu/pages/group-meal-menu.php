...
<?php include 'includes-pages/menu-navigation.php' ?>
        ...
        <div class="category-main-title">
            <h2 class="catg-title group-meal">Group Meal </h2>
        </div>
        <div class="row">
                ...
                <div class="menu-categories-card-container flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title group-title">Group Meal #1</h1>
                        </div>
                        <div class="mcc-ing mcc-group">
                            <li>Crab and Corn Soup</li> 
                            <li>Plain Rice</li> 
                            <li>Garlic Kangkong with Tofu</li>  
                            <li>Crispy Chicken (half)</li> 
            ...
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container mccc-right flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title group-title">Group Meal #2</h1>
                        </div>
                        <div class="mcc-ing mcc-group">
                                <li>Pancit Canton (Platter)</li> 
                                <li>Plain Rice (Platter)</li> 
                                <li>Chopsuey</li>  
            ...
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title group-title">Group Meal #3</h1>
                        </div>
                        <div class="mcc-ing mcc-group">
                                <li>Plain Rice (Platter)</li> 
                                <li>Pork BBQ</li>  
            ...
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container mccc-right flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title group-title">Group Meal #4</h1>
                        </div>
                        <div class="mcc-ing mcc-group">
                                <li>Salmon Cucido</li> 
                                <li>Plain Rice (Platter)</li> 
                                <li>Ampalaya con Karne</li> 
                                <li>Lechon Kawali</li>  
                                <li>Iced Tea Pitcher</li>  
                                <li>Leche Flan or Macaroni Salad</li> 
                        </div>
            ...
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title group-title">Group Meal #5</h1>
                        </div>
                        <div class="mcc-ing mcc-group">
                                <li>Crab and Corn Soup</li> 
                                <li>Plain Rice (Platter)</li> 
