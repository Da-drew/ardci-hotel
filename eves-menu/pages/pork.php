...
<?php include 'includes-pages/menu-navigation.php' ?>
        ...
        <div class="category-main-title">
            <h2 class="catg-title starter-title">Pork</h2>
        ...
        <div class="row">
                ...
                <div class="menu-categories-card-container flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Pork Adobo</h1>
                        </div>
                        <div class="mcc-ing">
            ...
            <!-- Sizzling Pork Sisig card -->
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container mccc-right flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Sizzling Pork Sisig</h1>
                        </div>
                        <div class="mcc-ing">
                            <p class="">
            ...
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Bicol Express</h1>
                        </div>
                        <div class="mcc-ing">
                            <p class="bicol-exp-p">
            ...
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container mccc-right flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Pork Steak</h1>
                        </div>
                        <div class="mcc-ing">
                            <p class="">
            ...
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Pork BBQ <span class="pork-bbq-sub">5 pieces</span></h1>
                        </div>
                        <div class="mcc-ing">
                            <p class="pork-bbq-p">
            ...
            <!-- Lumpiang Shanghai card -->
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container mccc-right flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Lumpiang Shanghai</h1>
                        </div>
                        <div class="mcc-ing">
                            <p class="">
            ...
            <!-- Sweet and Sour Meatballs card -->
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Sweet and Sour Meatballs</h1>
                        </div>
                        <div class="mcc-ing">
                            <p class="">
            ...
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container mccc-right flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Lechon <br> Kawali</h1>
                        </div>
                        <div class="mcc-ing">
            ...
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Pata Kare-Kare</h1>
                        </div>
                        <div class="mcc-ing">
                            <p class="">
            ...
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container mccc-right flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Pork <br> Sinigang</h1>
                        </div>
                        <div class="mcc-ing">
            ...
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container mccc-right flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Crispy Pata</h1>
                        </div>
                        <div class="mcc-ing">
            ...
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Pork Tapa</h1>
                        </div>
                        <div class="mcc-ing">
                            <p class="pork-tapa-p">
            ...
            <!-- Pork Dinakdakan card -->
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container mccc-right flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Pork Dinakdakan</h1>
                        </div>
                        <div class="mcc-ing">
                            <p class="">
            ...
            <!-- Tokwa't Babot in Tausi card -->
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Tokwa't Baboy in Tausi</h1>
                        </div>
                        <div class="mcc-ing">
                            <p class="">
            ...
            <!-- Pork w/ Mushroom card -->
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container mccc-right flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Pork w/ Mushroom</h1>
                        </div>
                        <div class="mcc-ing">
            ...
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container mccc-right flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Paksiw Pata</h1>
                        </div>
                        <div class="mcc-ing">
                            <p class="pork-mushroom-p">
