...
<?php include 'includes-pages/menu-navigation.php' ?>
        ...
        <div class="category-main-title">
            <h2 class="catg-title starter-title">Noodles</h2>
            <p class="catg-subtitle starter-sub-title">Served w/ 4 toasted bread. Good for 2-3 pax</p>
        </div>
        <div class="row">
            <!-- Canton Guisado -->
                ...
                <div class="menu-categories-card-container flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Canton Guisado</h1>
                        </div>
                        <div class="mcc-ing">
            ...
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container mccc-right flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Palabok</h1>
                        </div>
                        <div class="mcc-ing">
                            <p class="">
                                Glass noodles cooked in broth topped with egg, shrimp, tinapa, and chicharon mixed with palabok sauce.
                            </p>
                            <span class="in-prices">Price: &#8369;360.00</span>
                        </div>
                        <div class="add-list-con"><button class="add-list-btn" data-name="Palabok" onclick="noodlesArray(this)"><i class="fa-solid fa-clipboard-list"></i> Order</button></div>
                    </div>
                </div>
            </a>
            ...
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Canton Bihon</h1>
                        </div>
                        <div class="mcc-ing">
            ...
            <!-- Miki Bihon Guisado card -->
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container mccc-right flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Miki Bihon Guisado</h1>
                        </div>
                        <div class="mcc-ing">
                            <p class="">
            ...
            <!-- Chicken Chowmeian Noodles card -->
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container mccc-right flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Chicken Chowmeian Noodles</h1>
                        </div>
                        <div class="mcc-ing">
                            <p class="">
                               Stir-fried noodles with tender chicken, crisp vegetables, and a savory soy sauce blend.
                            </p>
                            <span class="in-prices">Price: &#8369;310.00</span>
                        </div>
                        <div class="add-list-con"><button class="add-list-btn" data-name="Chicken-Chowmeian-Noodles" onclick="noodlesArray(this)"><i class="fa-solid fa-clipboard-list"></i> Order</button></div>
                    </div>
                </div>
            </a>
