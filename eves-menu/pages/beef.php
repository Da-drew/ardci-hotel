...
<?php include 'includes-pages/menu-navigation.php' ?>
        ...
        <div class="category-main-title">
            <h2 class="catg-title starter-title">Beef</h2>
        ...
        <div class="row">
                ...
                <div class="menu-categories-card-container flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Beef Tapa</h1>
                        </div>
                        <div class="mcc-ing">
                            <p class="">
            ...
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container mccc-right flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Beef Steak</h1>
                        </div>
                        <div class="mcc-ing">
                            <p class="beef-steak-p">
                                Beef slices marinated in soy and lemon topped with fried onion.
                            </p>
                            <span class="in-prices">Price: &#8369;365.00</span>
                        </div>
                        <div class="add-list-con"><button class="add-list-btn" data-name='Beef-Steak' onclick="beefArrayy(this)"><i class="fa-solid fa-clipboard-list"></i> Order</button></div>
                    </div>
                </div>
            </a>

            <!-- Cheesy Caldereta card -->
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Cheesy Caldereta</h1>
                        </div>
                        <div class="mcc-ing">
                            <p class="chessy-caldereta-p">
                                Traditional Caldereta recipe topped with cheese.
                            </p>
                            <span class="in-prices">Price: &#8369;440.00</span>
                        </div>
                        <div class="add-list-con"><button class="add-list-btn" data-name='Cheesy-Caldereta' onclick="beefArrayy(this)"><i class="fa-solid fa-clipboard-list"></i> Order</button></div>
                    </div>
                </div>
            </a>

            <!-- Beef and Veggies card -->
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container mccc-right flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Beef and Veggies</h1>
                        </div>
                        <div class="mcc-ing">
                            <p class="">
            ...
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Beef Stroganoff</h1>
                        </div>
                        <div class="mcc-ing">
                            <p class="">
            ...
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container mccc-right flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Beef Curry</h1>
                        </div>
                        <div class="mcc-ing">
            ...
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Beef Salpicao</h1>
                        </div>
                        <div class="mcc-ing">
            ...
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container mccc-right flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Nilagang Baka</h1>
                        </div>
                        <div class="mcc-ing">
            ...
            <a role="button" class="cards-anchor col-6 col-6">
                <div class="menu-categories-card-container flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Sinalpungan</h1>
                        </div>
                        <div class="mcc-ing">
                            <p class="sinalpungan-p">
                                Carabao tripe sauteed with bellpepper, onion, and other spices.
                            </p>
                            <span class="in-prices">Price: &#8369;280.00</span>
                        </div>
                        <div class="add-list-con"><button class="add-list-btn" data-name='Sinalpungan' onclick="beefArrayy(this)"><i class="fa-solid fa-clipboard-list"></i> Order</button></div>
                    </div>
                </div>
            </a>

            <!-- Beef with Broccoli card -->
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container mccc-right flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title">Beef With Broccoli</h1>
                        </div>
                        <div class="mcc-ing">
