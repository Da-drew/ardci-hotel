...
<?php include 'includes-pages/menu-navigation.php' ?>
        ...
        <!-- group meal menu title -->
        <div class="category-main-title">
            <h2 class="catg-title group-meal">Snack Package</h2>
        </div>
        <div class="row">

            <!--Snack Package #1 card -->
                ...
                <div class="menu-categories-card-container flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title group-title">Snack Package #1</h1>
                        </div>
                        <div class="mcc-ing mcc-group">
                                <li>Clubhouse</li> 
                                <li>Pancit Canton or Bihon (Platter)</li> 
            ...
            <!--Snack Package #2 card -->
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container mccc-right flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title group-title">Snack Package #2</h1>
                        </div>
                        <div class="mcc-ing mcc-group">
                                <li>Cliffhanger</li> 
                                <li>Sotanghon Guisado or Miki Bihon (Platter)</li> 
                                <li>Cheese Sticks</li> 
                                <li>Iced Tea Pitcher</li>  
                        </div>
            ...
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title group-title">Snack Package #3</h1>
                        </div>
                        <div class="mcc-ing mcc-group">
                                <li>3 pcs Toasted Bread</li> 
                                <li>Spaghetti or Carbonara (Platter)</li> 
            ...
            <!-- Snack Package #4 card -->
            <a role="button" class="cards-anchor col-6">
                <div class="menu-categories-card-container mccc-right flex-grow-1">
                    <div class="mcc-ing-preview">
                        <div class="mcc-tilte-head">
                            <h1 class="mcc-title group-title">Snack Package #4</h1>
                        </div>
                        <div class="mcc-ing mcc-group">
                                <li>Clubhouse</li> 
                                <li>Palabok (Platter)</li> 
