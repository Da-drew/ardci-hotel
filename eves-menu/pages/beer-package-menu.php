...
<?php include 'includes-pages/menu-navigation.php' ?>
        ...
        <!--Beer package menu title -->
        <div class="category-main-title">
            <h2 class="catg-title group-meal">Beer Package</h2>
        </div>
        <div class="row">

            <!--Package #1 card -->
            <div class="col-12 cards-items-c">
                <a role="button" class="cards-anchor">
                    <div class="menu-categories-card-container packages-card">
                        <div class="mcc-ing-preview">
                            <div class="mcc-tilte-head">
                                <h1 class="mcc-title group-title">Package #1</h1>
                            </div>
                            <div class="mcc-ing mcc-group beer-group">
                                   <li>1 Bucket Red Horse or San Miguel Beer (6pcs)</li> 
            ...
            <div class="col-12">
                <a role="button" class="cards-anchor">
                    <div class="menu-categories-card-container packages-card">
                        <div class="mcc-ing-preview">
                            <div class="mcc-tilte-head">
                                <h1 class="mcc-title group-title">Package #2</h1>
                            </div>
                            <div class="mcc-ing mcc-group beer-group">
                                   <li>1 Bucket San Mig Light or any flavored beer (6pcs)</li> 
                                   <li>Sizzling Sisig or Lumpiang Shanghai</li> 
                                   <li>Free Peanuts</li>
                            </div>
            ...
            <div class="col-12 cards-items-c">
                <a role="button" class="cards-anchor">
                    <div class="menu-categories-card-container packages-card">
                        <div class="mcc-ing-preview">
                            <div class="mcc-tilte-head">
                                <h1 class="mcc-title group-title">Package #3</h1>
                            </div>
                            <div class="mcc-ing mcc-group beer-group">
                                   <li>1 Bucket Red Horse or San Miguel Beer (6pcs)</li> 
                                   <li>Sizzling Sisig or Lumpiang Shanghai</li> 
            ...
            <div class="col-12">
                <a role="button" class="cards-anchor">
                    <div class="menu-categories-card-container packages-card">
                        <div class="mcc-ing-preview">
                            <div class="mcc-tilte-head">
                                <h1 class="mcc-title group-title">Package #4</h1>
                            </div>
                            <div class="mcc-ing mcc-group beer-group">
                                   <li>1 Bucket San Mig Light or any flavored beer (6pcs)</li> 
                                   <li>Sizzling Sisig or Lumpiang Shanghai</li> 
